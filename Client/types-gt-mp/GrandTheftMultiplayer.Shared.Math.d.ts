declare namespace GrandTheftMultiplayer.Shared.Math {
	...
	class Vector3 {
		...
		constructor(x: number, y: number, z: number);
		constructor();
		static Lerp(start: GrandTheftMultiplayer.Shared.Math.Vector3, end: GrandTheftMultiplayer.Shared.Math.Vector3, n: number): GrandTheftMultiplayer.Shared.Math.Vector3;
		static Distance(a: GrandTheftMultiplayer.Shared.Math.Vector3, b: GrandTheftMultiplayer.Shared.Math.Vector3): number;
		static DistanceSquared(a: GrandTheftMultiplayer.Shared.Math.Vector3, b: GrandTheftMultiplayer.Shared.Math.Vector3): number;
		ToString(): string;
		...
		static RandomXY(): GrandTheftMultiplayer.Shared.Math.Vector3;
