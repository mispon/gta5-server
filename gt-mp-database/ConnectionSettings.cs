        ...
        public IEnumerable<IConnectionStringSettings> ConnectionStrings {
            get {
                yield return new ConnectionSettings {
                    ...
                    ConnectionString = "Server=SERVER53;Database=gta-mp-server;User Id=sa;Password=Gta5Server;"
                    //ConnectionString = "Server=localhost;Database=gta-mp-server;User Id=sa;Password=Gta5Server;"
                };
            }
        }
    }
